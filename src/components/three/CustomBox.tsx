  ...
  return (
    ...
    >
      ...
      <group>
        ...
        <CustomText position={[-15, -2, 0]} text="Nick" color='pink' setTableBold={props.setTokyo} link="https://nickchinsen.com"/>
        <CustomText position={[6, -2, 0]} text="Chinsen" color='pink' setTableBold={props.setTokyo} link="https://nickchinsen.com"/>
